  ...
  return (
    <label className="flex items-center justify-between gap-4 py-3 cursor-pointer group">
      ...
      <span className="relative inline-flex h-6 w-11 shrink-0 rounded-full overflow-hidden">
        ...
        />
        <span className="absolute inset-0 rounded-full border border-gray-300 dark:border-slate-600 transition-colors duration-200 peer-checked:border-red-500" />
        <span className="absolute inset-0 rounded-full bg-gray-200 dark:bg-slate-600 transition-colors duration-200 peer-checked:bg-red-500" />
        <span
          className="absolute top-0.5 left-0.5 h-5 w-5 rounded-full bg-white dark:bg-slate-100 shadow transition-all duration-200 pointer-events-none
            peer-checked:left-[22px]
            peer-focus-visible:ring-2 peer-focus-visible:ring-red-500 peer-focus-visible:ring-offset-2 dark:peer-focus-visible:ring-offset-slate-900"
        />
      </span>
    </label>
  );
        ...
        >
          ...
          <div className="pt-3">
            ...
            <input
              ...
              className="w-full h-2 rounded-full appearance-none bg-gray-200 dark:bg-slate-600 accent-red-500
