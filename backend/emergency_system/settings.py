...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-xzrvpc+-%8z#%+n9(*u3+iyuihx-c&8ovjywankp!76@b6@x5q')
...
ML_MODEL_PATH = BASE_DIR / config('ML_MODEL_PATH', default='ml_models/severity_model.pkl')